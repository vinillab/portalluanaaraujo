...
{
	wp_enqueue_style("navbar-scroll", get_template_directory_uri() . "/assets/css/navbar-scroll.css", [], "1.0.1");
	wp_enqueue_script("navbar-scroll", get_template_directory_uri() . "/assets/js/navbar-scroll.js", [], "1.0.1", true);
}
