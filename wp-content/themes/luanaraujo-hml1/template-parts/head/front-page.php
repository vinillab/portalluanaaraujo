...
<?php wp_enqueue_style("luanaraujo-hml1webflow", get_template_directory_uri() . "/assets/css/luanaraujo-hml1.css", [], filemtime(get_template_directory() . "/assets/css/luanaraujo-hml1.css")); ?>
...
WebFont.load({
    google: {
        families: ["Urbanist:300,regular,500,600,700,italic"]
    }
});
</script>
<script type="text/javascript">
