...
.w-slider-nav-invert .w-slider-dot.w-active {
  ...
  opacity: 1 !important;
    ...
    <main class="main-wrapper">
      <header id="blog-header-5" class="section_destaques_interna">
        <div class="heading_section-wrapper tx-1">
          <div class="margin-bottom margin-tiny">
            <div blocks-slot-children="ST232" blocks-name="blog-post-header3_breadcrumb" class="breadcrumb_component">
              <a blocks-name="breadcrumb-link" href="#" class="breadcrumb-link w-inline-block">
                <div>InICIO</div>
              </a>
              <div blocks-name="breadcrumb-divider" class="breadcrumb-divider w-embed"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="blog10_main-post">
                  <div class="blog10_main-list-wrapper">
                    <div class="blog10_main-list">
                      <div class="post_item">
                        <a href="#" class="post_item-link w-inline-block">
                          <div class="post_image-wrapper"><img sizes="(max-width: 1000px) 100vw, 1000px" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/depositphotos_405502886_xl-copia-1000x563-p-500.jpg?v=1742321523 500w, <?php echo get_template_directory_uri(); ?>/assets/images/depositphotos_405502886_xl-copia-1000x563-p-800.jpg?v=1742321523 800w, <?php echo get_template_directory_uri(); ?>/assets/images/depositphotos_405502886_xl-copia-1000x563.jpg?v=1742321523 1000w" alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/depositphotos_405502886_xl-copia-1000x563.jpg?v=1742321523" loading="lazy" class="ultimas_featured_image"></div>
                          <div class="spacer-small"></div>
                          <h3 class="heading-style-h5">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien pulvinar euismod. Lorem ipsum dolor sit amet consectetur.</h3>
                          <div class="spacer-xsmall"></div>
                          <div class="text-size-regular">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien pulvinar euismod vestibulum. Lorem ipsum dolor sit amet consectetur. Tincidunt sapien pulvinar euismod vestibulum.</div>
                          <div class="spacer-small"></div>
                          <div class="button-group">
                            <div class="post_meta-wrapper">
                              ...
                              <div class="text-size-small text-weight-semibold">5 min</div>
                            </div>
                    ...
                    <div class="blog10_featured-list">
                      <div class="post_item" sym="true">
                        <a href="<?php echo esc_url(home_url("interna-materia")); ?>" class="post_item-link w-inline-block">
                          <div class="spacer-xsmall"></div>
                          <h3 class="heading-style-h5">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien pulvinar.</h3>
                          <div class="spacer-xxsmall"></div>
                          <div class="text-size-regular">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien pulvinar euismod vestibulum. Lorem ipsum dolor sit amet consectetur.</div>
                          <div class="spacer-small"></div>
                          <div class="button-group">
                            <div class="post_meta-wrapper">
                              <div class="post_main_category">
      ...
      <header id="blog-header-5" class="section_posts">
        <div class="padding-global">
          <div class="container-large">
            <div class="padding-section-medium">
              <div class="posts_grid-wrapper">
                <div class="w-layout-grid post-list">
                  <div class="post_item" sym="true">
                    <a href="<?php echo esc_url(home_url("interna-materia")); ?>" class="post_item-link w-inline-block">
                      <div class="post_image-wrapper"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/placeholder-image-landscape.svg?v=1742321523" alt="" class="post_image"></div>
                      <div class="spacer-xsmall"></div>
                      <h3 class="heading-style-h5">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien pulvinar.</h3>
                      <div class="spacer-xxsmall"></div>
                      <div class="text-size-regular">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien pulvinar euismod vestibulum. Lorem ipsum dolor sit amet consectetur.</div>
              ...
              <div class="margin-top margin-xxlarge">
                <div blocks-name="button-group" blocks-slot-children="ST331" class="button-group is-center">
                  <a blocks-slot-item-canonical="EL14" blocks-name="button-4" href="#" class="button load-more w-button">VER&nbsp;MAIS</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="categories-menu" sym="true">
        <div class="padding-global">
          <div class="container-large">
            <div class="w-layout-grid categorias_grid-list">
              <div id="w-node-d1b1b6ce-5d7c-b9d0-8ea1-e04835e07be8-35e07be4" class="w-layout-grid categorias_row">
                <a href="<?php echo esc_url(home_url("categoria")); ?>" class="categoria_card bg-color-1 w-inline-block">
                  <div class="categoria_card-content">
                    <div class="categoria_card-content-top">
                      <h3 class="heading-style-h5">Notícias</h3>
                    </div>
                  </div>
                </a>
                <a href="<?php echo esc_url(home_url("categoria")); ?>" class="categoria_card bg-color-2 w-inline-block">
                  <div class="categoria_card-content">
                    <div class="categoria_card-content-top">
                      <h3 class="heading-style-h5">Saúde e Ciência</h3>
                    </div>
                  </div>
                </a>
                <a href="<?php echo esc_url(home_url("categoria")); ?>" class="categoria_card bg-color-3 w-inline-block">
                  <div class="categoria_card-content">
                    <div class="categoria_card-content-top">
                      <h3 class="heading-style-h5">Mundo e política</h3>
                    </div>
                  </div>
                </a>
                <a href="<?php echo esc_url(home_url("categoria")); ?>" class="categoria_card bg-color-4 w-inline-block">
                  <div class="categoria_card-content">
                    <div class="categoria_card-content-top">
                      <h3 class="heading-style-h5">Artigos</h3>
                    </div>
                  </div>
                </a>
              </div>
