<section class="section_posts">
    <div class="heading_section-wrapper bg-1">
        <h2 class="heading-style-h2">Saúde e Ciência</h2>
                ...
                <div class="posts_grid-wrapper">
                    <div class="w-layout-grid post-list">
                        <div class="post_item" sym="true">
                            <a href="<?php echo esc_url(home_url("interna-materia")); ?>"
                               class="post_item-link w-inline-block">
                                <div class="post_image-wrapper"><img loading="lazy"
                                         src="<?php echo get_template_directory_uri(); ?>/assets/images/placeholder-image-landscape.svg?v=1742321523"
                                         alt="" class="post_image"></div>
                                <div class="spacer-xsmall"></div>
                                <h3 class="heading-style-h5">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien
                                    pulvinar.</h3>
                                <div class="spacer-xxsmall"></div>
                                <div class="text-size-regular">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien
                                    pulvinar euismod vestibulum. Lorem ipsum dolor sit amet consectetur.</div>
                        ...
                        <div class="post_item three-col-post">
                            <a href="#" class="post_item-link w-inline-block">
                                <h3 class="heading-style-h5">Lorem ipsum dolor sit amet consectetur. Tincidunt sapien
                                    pulvinar euismod. Lorem ipsum dolor sit amet consectetur.</h3>
                                <div class="spacer-xxsmall"></div>
                                <div class="text-size-regular">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                ...
                                <div class="button-group">
                                    <div class="post_meta-wrapper">
                                        ...
                                        <div class="text-size-small text-weight-semibold">5 min read</div>
                                    </div>
                                    <div class="button is-link is-icon">
                                        <div>Read more</div>
                                        <div class="icon-embed-xxsmall w-embed"><svg width="16" height="16"
